...
impl<T: PRNG> Sampler<T> {
    ...
    unsafe fn next_sse2(&mut self, mu: __m128d, isigma: __m128d) -> i32 {
        ...
        // 1/(2*(1.8205^2))
        let inv2ss: __m128d = core::mem::transmute([INV_2SQRSIGMA0, INV_2SQRSIGMA0]);
        ...
        let ccs = _mm_mul_sd(isigma, _mm_load_sd(psm.wrapping_add(self.logn as usize)));
        ...
        loop {
            ...
            let x = _mm_sub_sd(
                x,
                _mm_mul_sd(_mm_cvtsi32_sd(_mm_setzero_pd(), z0 * z0), inv2ss),
            );
    ...
    unsafe fn ber_exp_sse2(&mut self, x: __m128d, ccs: __m128d) -> bool {
        ...
        let r = _mm_sub_sd(x, _mm_mul_sd(_mm_cvtsi32_sd(_mm_setzero_pd(), si), log2));
    ...
    fn ffsamp_fft_inner(
        ...
        if logn == 1 {
            unsafe {
                ...
                let leaf = _mm_mul_sd(_mm_sqrt_sd(_mm_setzero_pd(), d11_re), isigma);
                let y0 = _mm_cvtsi32_sd(_mm_setzero_pd(), self.next_sse2(w0, leaf));
                let y1 = _mm_cvtsi32_sd(_mm_setzero_pd(), self.next_sse2(w1, leaf));
                ...
                let b = _mm_add_pd(_mm_shuffle_pd(b1, b2, 2), _mm_shuffle_pd(b1, b2, 1));
                ...
                let leaf = _mm_mul_sd(_mm_sqrt_sd(_mm_setzero_pd(), d00_re), isigma);
                let y0 = _mm_cvtsi32_sd(_mm_setzero_pd(), self.next_sse2(x0, leaf));
                let y1 = _mm_cvtsi32_sd(_mm_setzero_pd(), self.next_sse2(x1, leaf));
                _mm_store_sd(tt0, y0);
        ...
        // back into tmp[2*n..3*n].
        {
            ...
            self.ffsamp_fft_inner(logn - 1, w0, w1, right_00, right_01, right_11, tmp);
        ...
        // tmp is free at this point.
        {
            ...
            self.ffsamp_fft_inner(logn - 1, w0, w1, left_00, left_01, left_11, tmp);
...
mod tests {
    ...
    impl PRNG for NotARealRNG {
        fn new(seed: &[u8]) -> Self {
            NotARealRNG::new(seed)
        }
        fn next_u8(&mut self) -> u8 {
            NotARealRNG::next_u8(self)
        }
        fn next_u16(&mut self) -> u16 {
            NotARealRNG::next_u16(self)
        }
        fn next_u64(&mut self) -> u64 {
            NotARealRNG::next_u64(self)
        }
    }
    ...
    const KAT512_OUT: [i32; 1024] = [
        -92, -8, -20, -12, 8, -30, -10, -41, -61, -46, -34, -44, -23, -40, -22, -50, -102, -58, 8,
        -7, -14, -14, 13, -64, -19, 4, 8, -40, -4, -13, 11, -94, -36, -15, -36, -90, -49, -17, -19,
        -74, -22, -35, -3, -85, -79, -45, -38, -4, -67, -33, -3, -1, -38, -14, 8, -48, 28, -30, 4,
        -26, -59, -93, -5, -14, -72, 10, -20, 0, -27, -54, 28, -84, -3, -2, 19, -16, -47, -38, -27,
        -56, -80, 0, -15, -18, -90, -33, -30, -71, 34, 32, 2, -8, -68, -43, -1, -41, -61, -58, 10,
